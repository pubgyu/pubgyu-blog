window.sinarioMotion = {
  ...
  rectsSinario: {
    ...
    tlEvent: function tlEvent() {
      ...
      this.tl.to(_message1, 0, {
        ...
        opacity: 1,
        ease: Sine.easeInOut
      }, 'st1+=1') // .to(_videoDoesText, 3, { opacity: 0 }, 'st1+=1')
  ...
  shootingStarSinario: {
    ...
    tlEvent: function tlEvent() {
      ...
      this.circlaTail6.tailP = -(this.colum * 2); // feed 6

      var tails = [// el, move position, size, delay
      ...
      if (!document.documentElement.classList.contains('en-page')) {
        ...
        for (var i = 0; i < tails.length; i++) {
          this.tailMotion(this.tl, tails[i][0], tails[i][1], tails[i][2], tails[i][3]);
        }
      ...
      if (STORY.wW > 767) {
        for (var _i = 0; _i < waves.length; _i++) {
          this.waveMotion(this.tl, waves[_i], _i * 1, _i * 0.7 + 5);
        } // feed 6
        ...
        for (var _i2 = 0; _i2 < waves.length; _i2++) {
          this.waveMotion(this.tl, waves[_i2], _i2 * 1, _i2 * 0.7 + 9);
        } // feed 6
      ...
      if (!document.documentElement.classList.contains('en-page')) {
        ...
        // tails
        for (var _i3 = 0; _i3 < tails.length; _i3++) {
          this.tailMotion(this.tl, tails[_i3][0], tails[_i3][1], tails[_i3][2], tails[_i3][3]);
        }
  ...
  sphereSinario: {
    ...
    tlEvent: function tlEvent() {
      ...
      if (STORY.wW > 767) {
        ...
        spheres = [// el, size, endsize, fill, angle, delay
        ...
        spheres2 = [// el, size, endsize, angle
        ...
        this.sphere8.radius = 840; // feed 7
      ...
      for (var i = 0; i < waves.length; i++) {
        this.waveMotion(this.tl, waves[i], i * .9, i * 0.7 + 7);
      } // feed 7-2
      ...
      for (var _i4 = 0; _i4 < spheres.length; _i4++) {
        this.sphereMotion(this.tl, spheres[_i4][0], spheres[_i4][1], spheres[_i4][2], spheres[_i4][3], spheres[_i4][4], spheres[_i4][5]);
      }

      for (var _i5 = 0; _i5 < spheres2.length; _i5++) {
        this.sphereMotion2(this.tl, spheres2[_i5][0], spheres2[_i5][1], spheres2[_i5][2], spheres2[_i5][3]);
      }
  ...
  fellowshipTextMotion: {
    ...
    scroll: function scroll(percent, percent2) {
      var total = this.tl._tDur; // feed 9
    ...
    tlEvent: function tlEvent() {
      ...
      if (STORY.wW > 767) {
        this.tl.to(_playBtn, 4, {
          ...
          height: resizeEW,
          ease: Sine.easeInOut
        }, "st5") // .to(stickyWrap.querySelector(".change-bg"), 4, { opacity: 0, ease: Sine.easeInOut, }, "st5")
        .to(stickyWrap.querySelector(".change-bg"), 3, {
          ...
          opacity: 0,
          ease: Sine.easeInOut
        }, "st5+=4.5") // .to(_videoDoesText.querySelector(".dimmed"), 3, { opacity: 1, ease: Sine.easeInOut }, "st5+=4.5");
        ...
        this.tl.to(_playBtn, 2, {
          ...
          opacity: 0,
          ease: Sine.easeInOut
        }, "st5+=2.2") // .to(_videoDoesText.querySelector(".dimmed"), 1.5, { opacity: 1, ease: Sine.easeInOut }, "st5+=2.2");
  ...
  fslideSinario: {
    ...
    tlEvent: function tlEvent() {
      ...
      fbox.find('.fbs').css('top', firstParent / 2 - fmgHeight / 2); // fbox
      ...
      var step = STORY.wW < 767 ? 4 : 2.5,
          ...
          width = fslide.find('.fslide-wrap').width() / _this.fslide.length; // CustomEase.create('wrapEase', 'M0,0 C0.564,0 0.661,0.176 0.7,0.4 0.712,0.47 0.766,0.972 1,1');
      ...
      fslide.find('.fslide-slide').each(function (index, el) {
        ...
        if (index < _this.fslide.length - 1) {
          ...
          var x = -width * (_this.fslide.length - 1) + (STORY.wW < 767 ? -width : -width / 2) + -STORY.wW / 2; // _this.tl.to('.fslide-wrap', step, { x: x, ease: 'wrapEase' }, 'fs1+=' + step * index);
        ...
        _this.tl.to($(el).find('figure.color'), miniStep, {
          ...
          opacity: 1
        }, 'fs1+=' + (step * index - miniStep)); // white button
        ...
        _this.tl.to('.fslide .button-container', miniStep, {
          ...
          opacity: 1
        }, index ? 'fs1+=' + (step * index - miniStep) : 'fs1-=' + miniStep); // message box
      ...
      fmessage.find('.fmessage-person').css('top', fakeText.eq(0).find('.fmessage-box').length * (fmgHeight + fmgMarginBottom) - fmgMarginBottom); // ending
    ...
    scroll: function scroll(percent) {
      ...
      if ($('.section-fslide').hasClass('show')) {
        ...
        _this.fslide.percent = Math.max(0, percent - 0.142); // navigation
    ...
    changeMessage: function changeMessage(text, breakWord) {
      ...
      if (STORY.wW < 360) {
        ...
        while (words.length) {
          var line = ''; // console.log(_this, text);
  ...
  voiceSinario: {
    ...
    tlEvent: function tlEvent() {
      ...
      _this.tl.pause(); // does matter scale
  ...
  voiceSinario2: {
    ...
    tlEvent: function tlEvent() {
      ...
      var bgSize2 = 'auto 125vh'; // load background
      ...
      $('.section-voice.v1 .txt-matter').css('transform', "translateY(".concat(titleY * bgLength, "px)")); // background image section
    ...
    init: function init() {
      var _this = this; // load background section
  ...
  voiceSinario3: {
    ...
    tlEvent: function tlEvent() {
      ...
      _this.tl.pause(); // input


      _this.input.maxSize = STORY.wW < 767 ? 32 : 84;
      _this.input.minSize = STORY.wW < 767 ? 18 : 32;
      _this.input.fontStep = STORY.wW < 767 ? 2.2 : STORY.wW < 1280 ? 4.4 : 3.6; // appear
